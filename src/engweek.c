...
#define MY_UUID { 0x70, 0x8F, 0xAE, 0xA8, 0x57, 0x4B, 0x47, 0x29, 0xBC, 0xA8, 0x68, 0xEF, 0x04, 0x4C, 0x94, 0x74 }
PBL_APP_INFO(MY_UUID, "EngWeek", "ripped from SimpleWeek", 1, 0 /* App version */, RESOURCE_ID_IMAGE_MENU_ICON, APP_INFO_WATCH_FACE);
